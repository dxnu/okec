...
//         double average_processing_time = 0.34;
...
//             // reward = -alpha * (cpu_demand / cpu_supply) + beta * (cpu_supply - cpu_demand);
...
//             Simulator::Schedule(Seconds(processing_time), [self, action, cpu_demand, &step, alpha, beta, average_processing_time]() {
